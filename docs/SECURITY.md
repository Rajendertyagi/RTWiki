...
| Maximum page JSON body (create/update) | 4 MB | `MAX_PAGE_JSON_BODY_BYTES` |
| Maximum HTML pane per page | 2 MiB UTF-8 | `MAX_HTML_BYTES` |
| Maximum CSS pane per page | 512 KiB UTF-8 | `MAX_CSS_BYTES` |
| Maximum JavaScript pane per page | 512 KiB UTF-8 | `MAX_JAVASCRIPT_BYTES` |
